...
/**
  ...
  *
  * <tt>ekf</tt> should be a pointer to a structure defined as follows, where
  <tt>N</tt> and </tt>M</tt> are
  * constants:
  * <pre>
...
/**
 * Runs one step of EKF prediction and update. Your code should first build a
 * model, setting the contents of <tt>ekf.fx</tt>, <tt>ekf.F</tt>,
