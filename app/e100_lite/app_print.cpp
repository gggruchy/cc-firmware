...
static void adjust_fan_based_on_filament(char * filament);
...
#endif
            adjust_fan_based_on_filament(slice_param.filament_type);
...
static void adjust_fan_based_on_filament(char * filament)
{
    ...
    if (fan_switch)
        ui_cb[manual_control_cb]((char *)"M106 P3 S255");
    else
        ui_cb[manual_control_cb]((char *)"M106 P3 S0");
}
...
#define TLP_MIN_PRINT_LAYER 60     // 模型最小层数
