...
static int evdev_rorate_mode = 0;
static int width = 0;
static int height = 0;
 ...
 */
void evdev_init(int w, int h, int rorate_mode)
{
    if (!evdev_set_file(EVDEV_NAME))
    {
        return;
    }
    evdev_rorate_mode = rorate_mode;
    width = w;
    height = h;
#if USE_XKB
    xkb_init();
...
void evdev_read(lv_indev_drv_t *drv, lv_indev_data_t *data)
{
    ...
    case 1:
        ...
        break;
    case 2:
        data->point.x = width - evdev_root_x;
        data->point.y = height - evdev_root_y;
        break;
    case 3:
        data->point.x = height - evdev_root_y;
        data->point.y = width - evdev_root_x;
        break;
    }
#endif
    data->state = evdev_button;
